...
class _PlanScreenState extends State<PlanScreen> {
  ...
  final carType =
          Provider.of<DriverInfoModelProvider>(context).driverInfo.carType;
      ...
      child: Scaffold(
          ...
          body: SingleChildScrollView(child: Column(
            children:   [
              ...
              GestureDetector(
                onTap: (){
                  checkamout1(carType,context,countryName);
                  print("ppppppp$countryName");
                },
                child: Padding(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          const Text("Cost : ",style: TextStyle(color: Colors.black45,fontSize:20.0)),
                            countryName =="Turkey"?
                            Text(carType=="Taxi-4 seats"?" TL 180":"TL 300",style: TextStyle(color: Colors.blueAccent.shade700,fontSize: 20.0,fontWeight: FontWeight.bold))
                                :Text(carType=="Taxi-4 seats"?" \$10":"\$20",style: TextStyle(color: Colors.blueAccent.shade700,fontSize: 20.0,fontWeight: FontWeight.bold)
              ...
              GestureDetector(
                onTap: ()=>checkAmount2(carType,context,countryName),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Container(
                    height: MediaQuery.of(context).size.height * 25 / 100,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children:  [
                            const Text("Cost : ",style: TextStyle(color: Colors.black45,fontSize:20.0)),
                            countryName =="Turkey"?
                            Text(carType=="Taxi-4 seats"?" TL 470":"TL 800",style: TextStyle(color: Colors.greenAccent.shade700,fontSize: 20.0,fontWeight: FontWeight.bold))
                                : Text(carType=="Taxi-4 seats"?" \$ 30":"\$ 55",style: TextStyle(color: Colors.greenAccent.shade700,fontSize: 20.0,fontWeight: FontWeight.bold))
                          ])
                      ],
                    ),
                  ),
              ...
              GestureDetector(
                onTap: ()=>checkAmount3(carType,context,countryName),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Container(
                    height: MediaQuery.of(context).size.height * 25 / 100,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children:  [
                            const Text("Cost : ",style: TextStyle(color: Colors.black45,fontSize:20.0)),
                            countryName =="Turkey"?
                            Text(carType=="Taxi-4 seats"?" TL 800":"TL 1350",style: TextStyle(color: Colors.purple.shade700,fontSize: 20.0,fontWeight: FontWeight.bold))
                                : Text(carType=="Taxi-4 seats"?" \$ 55":"\$ 95",style: TextStyle(color: Colors.purple.shade700,fontSize: 20.0,fontWeight: FontWeight.bold))
                          ],)
                      ],
                    ),
                  ),
