            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(AppLocalizations.of(context)!.planFinished,
                      style: const TextStyle(
                          color: Colors.black45, fontSize: 20.0)),
                ),
                Center(
                    child: Lottie.asset('images/8434-nfc-payment.json',
                        height: 300, width: 300)),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(AppLocalizations.of(context)!.chargeNow,
                      style: TextStyle(
                          color: Colors.greenAccent.shade700, fontSize: 24.0)),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child: Text(
                          AppLocalizations.of(context)!.toPayment,
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 16,
