...
class DriverInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bottomSheetValue= Provider.of<BottomSheetValue>(context).bottomSheetValue;
          ...
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Center(
                        child: Lottie.asset('images/43886-checking-and-scanning.json',
                  ...
                  const Padding(
                    ...
                    child: Text("Car Details",
                        style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold,color: Color(0xFFFFD54F))),
                  ),
                  CustomTextField().customTextField(
                    controller: carBrand,
                    keyboardType: TextInputType.name,
                  ...
                  Padding(
                    ...
                    child:
                        CustomDropBottom().dropBottomCustom(context, dropBottomValue),
                  ),
                  const SizedBox(
                    height: 15.0,
                  ),
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: ()=> checkIfTextFieldNotNull(bottomSheetValue,dropBottomValue,context),
                      child: Container(
            ...
            AnimatedPositioned(
              right: 0.0,
                ...
                child:CustomBottomSheet().customBottomSheet(context,bottomSheetValue,name,lastName,idNo,email,carBrand,carColor,carModel,dropBottomValue),
                duration: const Duration(milliseconds: 600)),
           indector==true? CircularInductorCostem().circularInductorCostem(context):const Text("")
          ],
        ),
      ),
    );
...
// this method for check if not null TextField to change bottomSheetValue for pick images
  checkIfTextFieldNotNull(double bottomSheetValue, String dropBottomValue, BuildContext context) {
